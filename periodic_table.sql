...
--
-- Name: elements unique_constr; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_constr UNIQUE (symbol, name);


--
-- Name: properties prop_elem_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT prop_elem_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties prop_types_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT prop_types_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
